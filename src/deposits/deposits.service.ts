...
export class DepositsService {
  ...
  async makeDeposit(depositDto: MakeDepositDto): Promise<ReturnValue> {
    ...
    const destinationAccount = await this.accountRepo.findById(
      depositDto.destinationAccount,
    );
    ...
    try {
      ...
      const transactions: Transactions = await Transactions.builder()
        ...
        .setSourceAccount(sourceAccount.accountNumber)
        .setDestinationAccount(destinationAccount.accountNumber);
